...
uint256 hashGenesisBlock("0x86586d33d8122ea0539543a87f0aee9e8976d9958bb09501d26bacc3535c24ec");
...
{
    if(nHeight == 1)
        return 9989488000 * COIN;

    int64 nSubsidy = 0.001 * COIN;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 5256000); // Ecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Ecoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // Ecoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x18506b3b6fb72f54b36efc77aa052564556a9dbb0c304f4b552aa61d2da51bbe");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "My First ECO-IN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0.001 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04dbd96f0f9f34083a795733ceccac650a2c9a0052882b93436c4bb51a71deeba7c98864edeeefa97e686a6ce4976db5d232e5ce9d1178f6d721e693fd1cfe120b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1536582143;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085314107;

        if (fTestNet)
        {
            block.nTime    = 1536582166;
            block.nNonce   = 386749246;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0448b5257832b696ce3dcb810ec7ce78e6dc953ed75ced06af9acbfdcd3065c8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb7, 0xdc }; // Ecoin: increase each by adding 2 to bitcoin's value.
